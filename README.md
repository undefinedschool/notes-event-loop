...
JavaScript es un lenguaje de programación _single-thread_, lo que equivale a decir que _sólo puede hacer 1 cosa a la vez_, ejecutar 1 sola instrucción y finalizarla antes de pasar a la siguiente.
